...
'''
    ...
    tracking_init = '\\1    added_attrs_per_dataset = [] if track_added_attrs else None\n'
...
\\1    )'''
    ...
    content = re.sub(old_attach_pattern, new_attach_code, content, flags=re.MULTILINE | re.DOTALL)
...
def main():
    ...
    print("Updating data source readers with YAML metadata loading and attribute tracking...\n")
