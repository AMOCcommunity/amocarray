    ...
    try:
        ...
        for i, (dataset, attr_changes) in enumerate(zip(datasets, attr_changes_list)):
            ...
            try:
                ...
                report_data = StandardizedDatasetReport(f'{array_name.upper()} {source_file}', dataset, attr_changes)
                ...
                if start_idx > 0:
                    for line in rst_lines[start_idx + 2:]:  # Skip filename and underline
                        lines.append(line)
                else:
...
def main():
    ...
    parser.add_argument('arrays', nargs='*', default=['rapid'], 
    ...
    if args.all:
        ...
        available_arrays = ['rapid', 'osnap', 'move', 'samba', 'fw2015', 'mocha', 'wh41n', 'dso']
