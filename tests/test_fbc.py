...
class TestFBC:
    ...
    def test_read_fbc_basic_functionality(self, mock_print_info, mock_load_metadata, 
                                          mock_attach_metadata, mock_load_dataset, 
                                          mock_resolve_path):
    ...
    @patch('amocatlas.data_sources.fbc.ReaderUtils.load_array_metadata_with_fallback')
    @patch('amocatlas.data_sources.fbc.ReaderUtils.print_loading_info')
    def test_read_fbc_transport_only_flag(self, mock_print_info, mock_load_metadata,
                                          mock_attach_metadata, mock_load_dataset,
                                          mock_resolve_path):
    ...
    @patch('amocatlas.data_sources.fbc.ReaderUtils.load_array_metadata_with_fallback')
    @patch('amocatlas.data_sources.fbc.ReaderUtils.print_loading_info')
    def test_read_fbc_track_added_attrs(self, mock_print_info, mock_load_metadata,
                                        mock_attach_metadata, mock_load_dataset,
                                        mock_resolve_path):
    ...
    def test_read_fbc_unsupported_file_type(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch('amocatlas.data_sources.fbc.ReaderUtils.load_array_metadata_with_fallback') as mock_metadata:
