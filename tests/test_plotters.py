...
def test_show_contents_variables_dataset(sample_dataset):
...
def test_show_contents_attributes_dataset(sample_dataset):
...
def test_show_contents_invalid_input():
...
def test_show_contents_invalid_content_type(sample_dataset):
...
def test_show_variables_dataset(sample_dataset):
...
def test_show_attributes_dataset(sample_dataset):
...
def test_show_variables_by_dimension_with_matching_dim(sample_dataset):
...
def test_show_variables_by_dimension_no_match(simple_dataset):
...
def test_plot_amoc_timeseries_basic(simple_dataset):
...
def test_plot_amoc_timeseries_with_resampling(simple_dataset):
...
def test_plot_amoc_timeseries_multiple_datasets():
...
def test_plot_amoc_timeseries_error_handling():
...
def test_plot_monthly_anomalies():
...
def test_add_amocatlas_timestamp():
...
def test_show_functions_edge_cases():
